...
public class Adapter_Produto extends ArrayAdapter<Tabela_Produtos> {

    public Adapter_Produto(@NonNull Context context, ArrayList<Tabela_Produtos> sptab) {
        super(context, 0,sptab);
    }
    ...
    public View iniView(int position, View convertView, ViewGroup parent) {
        ...
        Tabela_Produtos currentItem = getItem(position);
        if(currentItem!=null) {
            txtitem.setText(currentItem.getNomeproduto());
        }
        return convertView;
    }
}
