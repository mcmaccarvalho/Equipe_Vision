...
public class Frag_Add_Install extends Fragment {

    private HomeViewModel homeViewModel;
    private EditText edtppoe,edtendereco,edtcompl,edtnumero,edtcep,edtmega;
    private TextView txtcontppoe,txtcontend,txtcontcompl,txtvcto,txtpzad,txttipoadesao,txttipomensal;
    private TextView txfplano,txftv,txfinstal,txfvplano,txfvtv,txfvinstal,txfvtotal,txtdata,txtnome;
    ...
    private String NOME,ENDERECO,NUMERO,CEP,COMPL,INSTAL,SETOR,LINK,PLANO,TV,COBRANCA,VCTO,PPOE,ADESAO,
            VALORPLANO, VALORTV,VALORADESAO,KEYCLI,MEGA,VALORTVTIT,VALORPLANOTIT;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_frag__add__install, container, false);
        initViews(v);
        return v;
    }
    ...
    private void initViews(View v) {
        ...
        INSTAL="";SETOR="";LINK="";PLANO="";TV="";COBRANCA="";VCTO="";PPOE="";ADESAO="";
        VALORPLANO="";VALORTV="";VALORADESAO="";KEYCLI="";MEGA="";
        NOME="";ENDERECO="";NUMERO="";CEP="";COMPL="";
        STATUSADESAO=0;
        ...
        homeViewModel.getNumerobol().observe(this, new Observer<Integer>() {
            @Override
            public void onChanged(Integer bol) {
                Log.i("datasvcto","numeroBol getNumerobol():" +numeroBol );
                switch (bol) {
        ...
        btcancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MainActivity.navController.navigate(R.id.action_frag_Add_Install_to_frag_Consulta_Cli);
            }
        });
...
//
    ...
    private void salvar() {
        ...
        if(ENDERECO.equals("")){
            util.showSnackError(clcad,"Digite um Endereço para a Instalação.");
            return;
        }else if(NUMERO.equals("")){
            util.showSnackError(clcad,"Digite um Número para o endereço.");
            return;
            ...
            util.showSnackError(clcad,"Selecione o Tipo de Adesão.");
            return;
        }else if(PPOE.equals("")) {
    ...
    private void cadastraCli() {
        ...
        iins.setCep(CEP);
        iins.setCliente(cliente.getKeycli());
...
//
//
//        Instant it = Instant.ofEpochMilli(time);
//        ZonedDateTime zdt = it.atZone(ZoneId.systemDefault());
//        LocalDate dtt = zdt.toLocalDate();
//        DateTimeFormatter dfmt = DateTimeFormatter
//                .ofPattern("MMM-uu")
//                .withResolverStyle(ResolverStyle.STRICT);
//        String scomp = dtt.format(dfmt);
//        DateTimeFormatter nfmt = DateTimeFormatter
//                .ofPattern("dd-MM-yyyy")
//                .withResolverStyle(ResolverStyle.STRICT);
//        String datacompleta = dtt.format(nfmt);
...
//        alerta_boleto.show(getActivity().getSupportFragmentManager(), "DialogTeclado");
    ...
    private void geraAdesao() {
        ...
        Log.i("vctoadesao","getVcto_adesao(): " + Home.Settings.getPzo_vcto_adesao()+ " : " + somadias);
        dtt=dtt.plusDays(somadias);
        DateTimeFormatter dfmt = DateTimeFormatter
                .ofPattern("dd-MM-yyyy")
                .withResolverStyle(ResolverStyle.STRICT);
        String scomp = dtt.format(dfmt);
        Log.i("vctoadesao","scomp: " +scomp);
        long time=0;
        try {
            String str_date= scomp;
            SimpleDateFormat formatter ;
            ...
            formatter = new SimpleDateFormat("dd-MM-yyyy");
            date = (Date) formatter.parse(str_date);
            Log.i("vctoadesao","date: " +date);
            time=date.getTime();
        } catch (Exception e) {
            System.out.println("vctoadesao err :"+e);
        }
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if(tit2==null){
                                            ...
                                            util.showSnackOk(clcad, "Instalação salva com sucesso.");
                                            sair();
    ...
    private void sair(){
        ArrayList<Instalacoes> ii = HomeViewModel.getArrayinstall();
        ii.add(instalacao);
        HomeViewModel.setArrayinstall(ii);
        MainActivity.navController.navigate(R.id.action_frag_Add_Install_to_frag_Consulta_Cli);
    }
